...
?>
    <div class="container-fluid">
        <div class="card-header py-3">
            ...
            <h1 class="h3 mb-4 text-gray-800">Tambah Jawaban <?php echo $d['pertanyaan']; ?></h1>
    ...
    if (isset($_POST['submit'])) {
        ...
        mysqli_query($db, "INSERT INTO jawaban (id_jawaban, jawaban, nis, id_soal) VALUES ('','$jawaban', '$nis', '$id_soal')");
